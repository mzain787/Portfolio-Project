...
const NotFound  = () => {
  return (
    <>
    <div className="relative not-found-page pt-40 pb-0 pr-24 pl-24 flex flex-col justify-center items-center">
     <p className='text-sm font-bold text-purple-200 tracking-widest'>😭 I&#39;M SORRY</p>
      ...
      <img src={manImage.src} alt="man-image" className='not-found-image'/>
